...
const [mcpIdToEdit, setMcpIdToEdit] = createSignal<string | false>(false)
        ...
        <form
          ...
          onSubmit={async (event) => {
            ...
            await queryClient.invalidateQueries(
              queries.mcps.byId(parsedFormData.id),
            )
            setMcpIdToEdit(false)
          }}
        >
...
export {
  mcpIdToEdit as editMCPModalOpen,
  setMcpIdToEdit as setEditMCPModalOpen,
}
