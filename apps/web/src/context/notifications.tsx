...
const NotificationsContext = createContext<[TNotification[], SetStoreFunction<TNotification[]>]>();
...
function useNotifications() {
	...
	if (!store) throw new Error('useNotifications must be used within a NotificationsProvider');
