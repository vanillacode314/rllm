...
export const MarkdownRoot: Component<{
  context: Context;
  node: Root;
}> = (props) => <MarkdownChildren context={props.context} node={props.node} />;
...
export const MarkdownText: Component<{
  ...
  const childProps = createMemo(() => {
    ...
    return { component, context, properties };
  });

  return (
    <Show fallback={props.node.value} when={childProps().component}>
...
export const MarkdownNode: Component<{
  ...
  return (
    <Dynamic component={childProps().component} {...childProps().properties}>
      <MarkdownChildren context={childProps().context} node={props.node} />
    </Dynamic>
  );
};
